...
if __name__ == "__main__":
	...
	for key in oldObjectPool:
		...
		if (oldObjectPool[key].queueData > 500):
			flagSizeIssue = True

	if (flagConsumerDown and flagSizeIssue):
		print("WARNING: No consumers found for queue, ingest queue size larger than set limit of 500.")
		sys.exit(1)
	elif flagSizeIssue:
		print("WARNING: Queue size larger than set limit of 500.")
		sys.exit(1)
